<div align="center">
  ...
  <h1>Tarn Theme for iTerm2</h1>
  <p>A dark color preset for <a href="https://iterm2.com">iTerm2</a> inspired by the stillness of a high-altitude glacial lake — deep navy depths, steel blue shimmers, and teal-to-azure syntax highlighting.</p>
...
**Double-click** `tarn.itermcolors` to import it automatically, or:

1. Open **iTerm2 → Preferences** (`Cmd+,`)
2. Go to **Profiles → Colors**
3. Click **Color Presets…** → **Import…**
4. Select `tarn.itermcolors`
5. Choose **Tarn** from the Color Presets dropdown
