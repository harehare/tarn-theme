<div align="center">
  ...
  <h1>Tarn Theme for Alacritty</h1>
  <p>A dark theme for <a href="https://alacritty.org">Alacritty</a> inspired by the stillness of a high-altitude glacial lake — deep navy depths, steel blue shimmers, and teal-to-azure syntax highlighting.</p>
...
| Black      | `#162032` | ![](https://img.shields.io/badge/-%23162032-162032?style=flat-square) |
...
| Magenta    | `#b794f4` | ![](https://img.shields.io/badge/-%23b794f4-b794f4?style=flat-square) |
...
cp tarn.toml ~/.config/alacritty/themes/tarn.toml
```

Then import the theme in `~/.config/alacritty/alacritty.toml`:

```toml
import = [
  "~/.config/alacritty/themes/tarn.toml"
]
```
