<div align="center">
  ...
  <h1>Tarn Theme for Helix</h1>
  <p>A dark theme for <a href="https://helix-editor.com">Helix</a> inspired by the stillness of a high-altitude glacial lake — deep navy depths, steel blue shimmers, and teal-to-azure syntax highlighting.</p>
...
```bash
cp tarn.toml ~/.config/helix/themes/tarn.toml
```
