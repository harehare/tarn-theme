<div align="center">
  ...
  <h1>Tarn Theme for Zed</h1>
  <p>A dark theme for <a href="https://zed.dev">Zed</a> inspired by the stillness of a high-altitude glacial lake — deep navy depths, steel blue shimmers, and teal-to-azure syntax highlighting.</p>
...
| Keywords   | `#bb9af7` | ![](https://img.shields.io/badge/-%23bb9af7-bb9af7?style=flat-square) |
...
| Comments   | `#8191a8` | ![](https://img.shields.io/badge/-%238191a8-8191a8?style=flat-square) |
| Operators  | `#94a3b8` | ![](https://img.shields.io/badge/-%2394a3b8-94a3b8?style=flat-square) |

## Installation

Copy `tarn.json` to your Zed themes directory:

```bash
cp tarn.json ~/.config/zed/themes/
```
